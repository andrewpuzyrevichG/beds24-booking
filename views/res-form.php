...
<!--            <input type="text" readonly name="date_end" id="date-3_2" value="--><?php //echo $date_end; ?><!--"-->
                    ...
                    <div class="clients-blk">
                        ...
                        <input type="checkbox" id="animals" name="animals" <?php if ($animals == 'on') {
                            echo 'checked';
                                ...
                                style="font-weight: 600;color: black; font-size: 18px;margin-bottom: 0; margin-left: 10px;"
                                for="animals"><?php _e('Vi har hund med oss.', 'beds24'); ?></label>
