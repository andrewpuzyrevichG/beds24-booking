...
//        array_push($dataArr,array('roomId'=> $roomID, 'calendar'=>$calendarArr));
    ...
    public function sendDepositRemind($orderID){
        ...
        if (get_locale()=='sv_SE')
        {
            $subject = 'Påminnelse om sista betalning';
        } else {
...
//var_dump($depositPartialPaymentsData);
        ...
        foreach ($order->get_items() as $item_key => $item) {
            ...
            if (!empty(get_field('facts',$item_data['product_id']))){
            ...
            $message .= '<tr>
                ...
                <td style="padding: 10px;">
                    ...
                    <p style="margin-bottom: 5px; margin-top: 0px; font-size: 16px; font-weight: 600; line-height: 20px; color: #000;"><strong>' . $product_name . '</strong></p>

                    <p style="margin-bottom: 5px; margin-top: 0px; font-size: 16px; line-height: 22px; padding: 0; font-weight: 500; color: #000;"><i> '.$facts.'</i></p>';
            ...
            $message .= '<p style="margin-bottom: 5px; margin-top: 0px; font-size: 16px; line-height: 22px; padding: 0; font-weight: 500; color: #000;">
                        '.__('TILLTRÄDE:','beds24').' <strong> ' . $bookedFrom . '</strong> '.__('från  16:00  AVRESA:','beds24').' <strong>' . $bookedTo . '</strong> '.__('senast 11:00','beds24').'  </p>
                    <p style="margin-bottom: 5px; margin-top: 0px; font-size: 16px; line-height: 22px; padding: 0; font-weight: 500; color: #000;">' . $personsAdult .' '.__('VUXNA','beds24') .', ' . $personsChild .' '.__('BARN','beds24'). ', ' . $hund . '</p>
                </td>
            </tr>';
            $pt++;
            $itr2++;
        ...
        $message .= '<tr>
                <td style="padding: 10px;">
                    <table width="100%" style="border-collapse: collapse;" class="nopad-t">
                        <tr>
                            <th style="font-size: 16px;border-radius: 5px 0 0 5px; font-weight: 600; line-height: 20px; color: #000; padding: 3px 8px; text-align: left; background-color: #e5e5e5;">'.__('AVGIFTER','beds24').'</th>
                            <th style="padding: 8px; text-align: left;border-radius:0 5px 5px 0; background-color: #e5e5e5;"></th>
                        </tr>';
...
//            var_dump($price_by_period);
            $future_date = date('Y-m-d', strtotime('-30 days', strtotime($getFirstAmountDate)));
                ...
                $message .= '<tr>
                            <td style="padding: 20px 8px 8px 8px; font-size: 16px; font-weight: 600; line-height: 20px; color: #000;">' . $product_name . '</td>
                            <td style="font-size: 16px; font-weight: 500; line-height: 20px; color: #000; padding: 8px; text-align: right; padding-right: 100px;">' . $price_by_period. ' ' . $currency . '</td>
                        </tr>';
                if(!empty($order->get_items('fee'))){
                    foreach ($order->get_items('fee') as $key => $item_fee) {
                        $message .= '<tr>
                            <td style="font-size: 16px; font-weight: 500; line-height: 20px; color: #000; padding: 8px;">'.$item_fee->get_name().'</td>
                            <td style=" text-transform: uppercase;font-size: 16px; font-weight: 500; line-height: 20px; color: #000; padding: 8px; text-align: right; padding-right: 100px;">'.$item_fee->get_total().' '.$currency.'</td>
                        </tr>';
                    }
                }
                if (!empty($item->get_meta('Hund'))) {
                    ...
                    $message .= '<tr>
                            <td style="font-size: 16px; font-weight: 500; line-height: 20px; color: #000; padding: 8px;">'.__('Hunddeposition','beds24').'</td>
                            <td style=" text-transform: uppercase;font-size: 16px; font-weight: 500; line-height: 20px; color: #000; padding: 8px; text-align: right; padding-right: 100px;">'.$w.' '.$currency.'</td>
                        </tr>';
                }
                if (!empty($item->get_meta('Avresestädning'))) {
                    ...
                    $message .= '<tr>
                            <td style="font-size: 16px; font-weight: 500; line-height: 20px; color: #000; padding: 8px;">'.__('Avresestädning','beds24').'</td>
                            <td style=" text-transform: uppercase;font-size: 16px; font-weight: 500; line-height: 20px; color: #000; padding: 8px; text-align: right; padding-right: 100px;">'.$w.' '.$currency.'</td>
                        </tr>';
                }
                if (!empty($item->get_meta('Avbokningskydd'))) {
                    ...
                    $message .= '<tr>
                            <td style="font-size: 16px; font-weight: 500; line-height: 20px; color: #000; padding: 8px;">'.__('Avbokningskydd','beds24').'</td>
                            <td style=" text-transform: uppercase;font-size: 16px; font-weight: 500; line-height: 20px; color: #000; padding: 8px; text-align: right; padding-right: 100px;">'.$w.' '.$currency.'</td>
                        </tr>';
                }
...
//        die();
            $message .= '<tr>
                            <td style="font-size: 16px; font-weight: 600; line-height: 20px; color: #000; padding: 20px 8px 8px 8px;"><strong>'.__('TOTALT','beds24').'</strong></td>
                            <td style="font-size: 16px; font-weight: 600; line-height: 20px; color: #000; padding: 8px; text-align: right; padding-right: 100px;"><strong style="color: #000;">' . round($order_data['total']) . ' ' . $currency . '</strong></td>
                        </tr>';
        ...
        $message .= '<tr>
                ...
                <td style="padding: 10px;">
                    <table width="100%" style="border-collapse: collapse;" class="nopad-t">
                        <tr>
                            <th style="border-radius: 5px 0 0 5px;font-size: 16px; font-weight: 600; line-height: 20px; color: #000; padding: 3px 8px; text-align: left; background-color: #e5e5e5;">'.__('GENOMFÖRDA BETALNINGAR','beds24').'</th>
                            <th style="border-radius:0 5px 5px 0;padding: 8px; text-align: left; background-color: #e5e5e5;"></th>
                        </tr>

                        <tr>
                            <td style="font-size: 16px; font-weight: 600; line-height: 20px; color: #000; padding: 8px;">'.__('Delbetalning','beds24').':</td>
                            <td style="font-size: 16px; font-weight: 600; line-height: 20px; color: #000; padding: 8px; text-align: right; padding-right: 100px;">'. round($depositPartialPaymentsData['deposit']['total']) . ' ' . $currency . '</td>
                        </tr>
                        <tr>
                         <td style="font-size: 16px; font-weight: 500; line-height: 20px; color: #000; padding: 8px;"> <span style="text-transform: capitalize;">'. $pay_type.'</span>, ' . $formatted_date . '</td>
                        </tr>
                        <tr>
                            <td style="font-size: 16px; font-weight: 600; line-height: 20px; color: #000; padding: 20px 8px 8px 8px;"><strong>'.__('TOTALT','beds24').'</strong></td>
                            <td style="font-size: 16px; font-weight: 600; line-height: 20px; color: #000; padding: 20px 8px 8px 8px 8px; text-align: right; padding-right: 100px;"><strong style="color: #000;">' . round($depositPartialPaymentsData['deposit']['total']) . ' ' . $currency . '</strong></td>
                        </tr>
                    </table>
                </td>
        ...
        $message .= '<tr>
                ...
                <td style="padding: 10px;">
                    <table width="100%" style="border-collapse: collapse;" class="nopad-t">
                        <tr>
                            <th style="border-radius: 5px 0 0 5px;font-size: 16px; font-weight: 600; line-height: 20px; color: #000; padding:3px 8px; text-align: left; background-color: #e5e5e5;">'.__('RESTERANDE BETALNINGAR','beds24').'</th>
                            <th style="border-radius:0 5px 5px 0;padding: 8px; text-align: left; background-color: #e5e5e5;"></th>
                        </tr>
                        <tr>
                            <td style="padding: 8px; padding-bottom: 0px; font-size: 16px; font-weight: 600; line-height: 20px; color: #000;">'.__('Slutbetalning:','beds24').'</td>
                            <td style="font-size: 16px; font-weight: 600; line-height: 20px; color: #000; padding: 8px; text-align: right; padding-right: 100px;">' . round($depositPartialPaymentsData['unlimited']['total']) . ' ' . $currency . '</td>
                        </tr>
                        <tr> <td style="padding: 8px;padding-top: 0px; font-size: 16px; font-weight: 500; line-height: 20px; color: #000;">'.__('Förfallodag:','beds24').' ' . $future_date . '</td></tr>';
        $message .= '<tr>
                            <td style="font-size: 16px; font-weight: 600; line-height: 20px; color: #000; padding: 20px 8px 8px 8px;"><strong>'.__('TOTALT','beds24').'</strong></td>
                            <td style="font-size: 16px; font-weight: 600; line-height: 20px; color: #000; padding:  8px; text-align: right; padding-right: 100px;">' . round($depositPartialPaymentsData['unlimited']['total']) . ' ' . $currency . '</td>
                        </tr>
